...
function NewInventoryItemRequest() {
  ...
  const {
    ...
    getStoreItemIsError,
    addPurchaseRequestIsError,
    addPurchaseRequestIsSuccess,
    ...
    <div className="drawer-content-custom f9">
      <div className=" inline-block bg-white mt-5 w-[92%] p-5">
        <div className=" float-left">
          ...
          <p className="text-s my-3">Create a purchase request for an inventory item</p>
        </div>
      </div>
      <hr />
        ...
        <div className="lg:grid grid-cols-2 gap-2 bg-white p-5 shadow-lg m-2 lg:m-10">
          ...
          <div className="ccol-start-2 col-span-1">
            <p>
              ...
              <input
                ...
                id="category"
                value={itemCategory}
                onChange={(e) => onStoreItemCategoryChange(e.target.value)}
                disabled
              />
            </p>
          </div>
          ...
          <div className="col-start-2 col-span-1">
            <p>
              ...
              <input className="input input-sm input-bordered w-full" type="text" id="unit" value={unit} disabled />
            </p>
          </div>
