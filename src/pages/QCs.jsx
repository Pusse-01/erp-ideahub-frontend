...
function QCs() {
  ...
  const [curser, setCurser] = useState(50)
  ...
  return (
    <>
      <div className="drawer-content-custom f9">
        ...
        <div className="grid grid-cols-12 grid-flow-row bg-white w-[92%] gap-1 lg:gap-2 text-sm lg:text-base p-3 pl-6">
          <div className="col-start-2  ">No</div>
          <div className="col-start-3 col-span-2 ">Items</div>
          <div className="col-start-5 col-span-2  ">Description</div>
          <div className="col-start-7 col-span-2  ">Assigned To</div>
          <div className="col-start-9 col-span-2  ">Remarks</div>
          <div className="col-start-11 col-span-2">Status</div>
