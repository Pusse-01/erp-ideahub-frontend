...
import { getAllInventoryItemCategories, createInventoryItem, reset } from '../features/stores/storesSlice';
...
function NewStoreItem() {
  ...
  }, [getAllInventoryItemCategoriesIsError, getAllInventoryItemCategoriesIsSuccess]);
