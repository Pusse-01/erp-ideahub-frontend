...
function Jobs() {
  const { jobs, isLoading, isSuccess, jobCount, jobCountRevision, jobCountProduction, deleteJobIsSuccess, deleteJobIsError, message } = useSelector((state) => state.job);
    ...
    <>
      <div className="drawer-content-custom f9">
        ...
        <div className=" lg:flex items-center justify-start bg-white w-[92%] p-1 lg:p-5">
          ...
          {location.pathname && location.pathname === '/jobs' ? (<Link to="/new-job" className="font-medium">
            <button
              type="button"
        ...
        <div className="grid grid-cols-12 grid-flow-row bg-white w-[92%] gap-1 lg:gap-2 text-sm lg:text-base">
          ...
          {location.pathname && location.pathname === '/jobs' ? <div className="col-start-8 col-span-2 ">Production Status</div> : <></>}
          {location.pathname && location.pathname === '/jobs-view' ? <div className="col-start-8 col-span-2 ">Stage</div> : <></>}  
