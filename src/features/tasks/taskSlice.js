...
export const createTasks = createAsyncThunk('tasks/create', async (taskData, thunkAPI) => {
  try {
...
export const updateTasks = createAsyncThunk('tasks/update', async (taskData, thunkAPI) => {
  try {
    const token = thunkAPI.getState().auth.user.token;
...
export const getAllTasks = createAsyncThunk('tasks/getAllTasks', async (curser, thunkAPI) => {
  try {
    const token = thunkAPI.getState().auth.user.token;
    return await taskService.getAllTasks(curser, token);
  } catch (error) {
    const message =
      (error.response && error.response.data && error.response.data.message) || error.message || error.toString();
    return thunkAPI.rejectWithValue(message);
...
export const getTasksByJobNo = createAsyncThunk('tasks/getTasksByJobNo', async (jobNo, thunkAPI) => {
  try {
    const token = thunkAPI.getState().auth.user.token;
...
export const getTask = createAsyncThunk('tasks/get', async (taskId, thunkAPI) => {
  try {
    const token = thunkAPI.getState().auth.user.token;
...
export const deletePlan = createAsyncThunk('tasks/deletePlan', async (taskId, thunkAPI) => {
  try {
    const token = thunkAPI.getState().auth.user.token;
...
export const updateStatus = createAsyncThunk('tasks/updateStatus', async (data, thunkAPI) => {
  try {
    const token = thunkAPI.getState().auth.user.token;
...
export const checkEmployeeAvailiblity = createAsyncThunk('tasks/checkEmployeeAvailiblity', async (filter, thunkAPI) => {
  try {
    const token = thunkAPI.getState().auth.user.token;
...
export const UpdateTasksQCcompleted = createAsyncThunk('tasks/UpdateTasksQCcompleted', async (data, thunkAPI) => {
  try {
    const token = thunkAPI.getState().auth.user.token;
