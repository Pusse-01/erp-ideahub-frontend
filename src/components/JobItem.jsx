...
function JobItem({ job }) {
  ...
  return (
    <>
      ...
      {location.pathname && location.pathname === '/jobs-view' ? <div className="col-start-8 col-span-2 flex items-center ">{job.stage}</div> 
      ...
      {location.pathname && location.pathname === '/jobs' ? <div className="col-start-12 col-span-1">
