			...
			<Router>
				<div className="container">
					...
					<Routes>
						...
						<Route
							path="/job/:jobId/add-subtask-enquiry"
							element={<PrivateRoute />}>
							<Route
								path="/job/:jobId/add-subtask-enquiry"
								element={<NewEnquirySubTask />}
							/>
						</Route>
						<Route
							path="/job/:jobId/add-subtask"
							element={<PrivateRoute />}>
							<Route
								path="/job/:jobId/add-subtask"
								element={<NewJobSubTask />}
							/>
						</Route>
						<Route
							path="/job/:jobId/edit"
						...
						<Route
							...
							<Route
								path="/new-manufacturing"
								element={<NewManufacturing />}
							/>
						</Route>
						<Route
							path="/update-manufacturing"
							element={<PrivateRoute />}>
							<Route
								path="/update-manufacturing"
								element={<UpdateManufacturing />}
							/>
						</Route>
						<Route
							...
							<Route
								path="/design-dashboard"
								element={<DesignDashboardEnquiries />}
							/>
						</Route>
						<Route
							path="/new-design"
						...
						<Route
							...
							<Route
								path="/quotation-dashboard"
								element={<QuotationDashboardEnquiries />}
							/>
						</Route>
						<Route
							path="/new-quotation"
						...
						<Route
							...
							<Route
								path="/manufacturing-dashboard"
								element={<ManufacturingDashboardJobs />}
							/>
						</Route>
						...
						<Route
							path="/new-inventory-item"
							element={<PrivateRoute />}>
							<Route
								path="/new-inventory-item"
								element={<NewStoreItem />}
							/>
						</Route>
						<Route
							path="/stores/:itemId/request"
							element={<PrivateRoute />}>
							<Route
								path="/stores/:itemId/request"
								element={<NewInventoryItemRequest />}
							/>
						</Route>
						<Route
							path="/stores/:itemId/edit"
							element={<PrivateRoute />}>
							<Route
								path="/stores/:itemId/edit"
